...
export class ValoracionEventoServices {
  ...
  alternarFavoritoContrato(idAnfitrion: number, idContratoEvento: number, valoracionEvento: ValoracionEvento){
    return this.httpclient.post(this.url + '/alternarfavorito/contrato/' + idAnfitrion + '/' + idContratoEvento, valoracionEvento);
  }
}
